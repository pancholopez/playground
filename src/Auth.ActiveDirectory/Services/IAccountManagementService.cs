...
public interface IAccountManagementService
{
    ...
    Result<IEnumerable<UserAccount>> SearchAccount(string name, string adServicePath);
    ...
    Result<UserAccount> CreateAccount(string ldapPath, NewUserAccount account);
    ...
    Result ResetPassword(UserAccount account, string password);
    ...
    Result AddUserToGroup(string samAccountName, string groupName);
    ...
    Result DeleteAccount(string samAccountName);
}
